...
const validation_get_one_product=[
      [
          body("introduce_product").notEmpty().withMessage("اندازه قد شلوار نمیتواند خالی باشد").trim().isLength({ min: 2 }).withMessage("طول این فیلد باید بیشتر از 3 کاراکتر باشد."),
      ]
  ]
